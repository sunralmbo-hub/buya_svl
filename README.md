...
> 把中文文章里的判断、流程、状态和隐喻，转成“不鸭不咋样”式白底、粗黑分镜、橙嘴白鸭、鸭群小漫画正文配图。
>
> 16:9 横版 | 不鸭不咋样 IP | 小漫画 | 鸭群 | 手写对白框 | 生活梗 | Codex Skill
...
默认视觉 IP 是“不鸭不咋样”：白色长脖子鸭子，橙色扁嘴，黑色小点眼睛，粗黑线轮廓，圆头鼓脸。常见画面是鸭群重复纹理、浅绿色背景块、手写对白框，以及一只特殊鸭。
...
- 大量相似普通鸭形成鸭群纹理，鸭嘴制造橙色节奏
- 特殊鸭可用粉色头冠、粉色标记、特殊姿势、留白或位置区分
...
参考图只用于校准不鸭的小漫画语法：粗黑分镜、鸭群密度、浅绿背景、橙嘴白鸭、特殊鸭、手写对白框。
...
每张图写清楚：放在哪段后、主题、核心意思、情绪关键词、小漫画分镜格式、鸭群如何出现、特殊鸭如何被区分、建议中文旁白。
...
要求：16:9 横版、粗黑漫画分镜、白色长脖子鸭、橙色扁嘴、小点眼、鸭群、浅绿背景、手写对白框。
